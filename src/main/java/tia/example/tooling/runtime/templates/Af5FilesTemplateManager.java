package tia.example.tooling.runtime.templates;
...
public class Af5FilesTemplateManager implements FileTemplateGroupDescriptorFactory {
    public static final String AF5_CONFIG_FILE = "AF5 Config";
    public static final String AF_MODULE_FILE = "AF5 Module";
